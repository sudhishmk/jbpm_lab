 ...
 * </p>
 */
public class CustomLDAPUserGroupCallbackImpl extends AbstractCustomLDAPUserGroupInfo implements UserGroupCallback {

    private static final String DEFAULT_PROPERTIES_NAME = "jbpm.usergroup.callback";
    
    private static final Logger log = LoggerFactory.getLogger(CustomLDAPUserGroupCallbackImpl.class);
    ...
    public CustomLDAPUserGroupCallbackImpl() {
        this(true);
    }
    public CustomLDAPUserGroupCallbackImpl(boolean activate) {
     ...
     */
    public CustomLDAPUserGroupCallbackImpl(Properties config) {
    ...
    public boolean existsUser(String userId) {
        ...
        boolean exists = existsEntity(userId, context, filter, attributeId);
        log.debug("Called Exist User with userId : " + userId +" context "+ context + " filter "+ filter+ " attributeId " + attributeId + " existsUser " + exists);
        return exists;
    }
    ...
    public boolean existsGroup(String groupId) {
        ...
        boolean exists = existsEntity(groupId, context, filter, attributeId);
        log.debug("Called Exist group with groupId : " + groupId +" context "+ context + " filter "+ filter+ " attributeId " + attributeId + " existsGroup " + exists);
        return exists;
    ...
    private boolean existsEntity(String entityId, String context, String filter, String attributeId) {
        ...
        boolean exists = entityId.equalsIgnoreCase(ldapEntityId);
        log.debug("Called Exist entity with entityId : " + entityId + " context "+ context + " filter "+ filter+ " attributeId " + attributeId + " existsGroup " + exists+" got the result"+ldapEntityId);
        return exists;
    }
    ...
    public List<String> getGroupsForUser(String userId) {
        ...
        log.debug("Called getGroupsForUser with userId : " + userId +" roleContext "+ roleContext + " roleFilter "+ roleFilter+ " roleAttributeId " + roleAttributeId);
        if (!isUserIdDn()) {
            String userContext = getConfigProperty(USER_CTX);
            String userFilter = getConfigProperty(USER_FILTER);
            log.debug("is Userid Dn true  userContext : " + userContext +" userFilter "+ userFilter );
        ...
        log.debug("List of groups  : " + result);
